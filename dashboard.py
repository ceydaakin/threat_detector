"""
Web dashboard for visualizing threats and network activity
"""
import json
import os
...
class Dashboard:
    """Manages the web dashboard for visualizing threat data."""
    ...
    def setup_routes(self):
        ...
        def get_threats():
            ...
            for threat in threats:
                threat_list.append({
                    ...
                    'src_ip': threat[2],
                    'dst_ip': threat[3],
                    'threat_type': json.loads(threat[4]) if threat[4] else [],
                    'threat_score': threat[5],
                    'severity': threat[6],
                    'details': json.loads(threat[7]) if threat[7] else []
                })
        ...
        def get_statistics():
            ...
            activity_stats = self.db.get_activity_statistics()
            return jsonify({
